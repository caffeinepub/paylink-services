...
import type { DishTVRechargeLead as _DishTVRechargeLead, ExternalBlob as _ExternalBlob, MobileRechargeLead as _MobileRechargeLead, UserProfile as _UserProfile, UserRole as _UserRole, WifiBookingLead as _WifiBookingLead, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllDishTVRechargeLeads(): Promise<Array<DishTVRechargeLead>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllDishTVRechargeLeads();
    ...
    async getAllMobileRechargeLeads(): Promise<Array<MobileRechargeLead>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllMobileRechargeLeads();
    ...
    async getAllPaymentBankServiceRequests(): Promise<Array<PaymentBankServiceRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPaymentBankServiceRequests();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllWifiBookingLeads(): Promise<Array<WifiBookingLead>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllWifiBookingLeads();
    ...
    async getApprovedWifiBookingLeads(): Promise<Array<WifiBookingLead>> {
        if (this.processError) {
            try {
                const result = await this.actor.getApprovedWifiBookingLeads();
                return from_candid_vec_n18(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPendingMobileRechargeLeads(): Promise<Array<MobileRechargeLead>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPendingMobileRechargeLeads();
                return from_candid_vec_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPendingWifiBookingLeads(): Promise<Array<WifiBookingLead>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPendingWifiBookingLeads();
                return from_candid_vec_n18(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitDishTVRechargeLead(arg0: string, arg1: string, arg2: string, arg3: ExternalBlob | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitDishTVRechargeLead(arg0, arg1, arg2, await to_candid_opt_n24(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitMobileRechargeLead(arg0: string, arg1: string, arg2: string, arg3: ExternalBlob | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitMobileRechargeLead(arg0, arg1, arg2, await to_candid_opt_n24(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitPaymentBankServiceRequest(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitPaymentBankServiceRequest(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateDishTVRechargeLeadStatus(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateDishTVRechargeLeadStatus(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateMobileRechargeLeadStatus(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMobileRechargeLeadStatus(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePaymentBankServiceRequestStatus(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePaymentBankServiceRequestStatus(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateWifiBookingLeadStatus(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
...
async function from_candid_DishTVRechargeLead_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DishTVRechargeLead): Promise<DishTVRechargeLead> {
...
async function from_candid_MobileRechargeLead_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MobileRechargeLead): Promise<MobileRechargeLead> {
...
async function from_candid_WifiBookingLead_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _WifiBookingLead): Promise<WifiBookingLead> {
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    id: bigint;
    status: string;
    paymentScreenshotFile: [] | [_ExternalBlob];
    operator: string;
    createdAt: bigint;
    customerId: string;
    amount: string;
    ...
    return {
        id: value.id,
        status: value.status,
        paymentScreenshotFile: record_opt_to_undefined(await from_candid_opt_n13(_uploadFile, _downloadFile, value.paymentScreenshotFile)),
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_DishTVRechargeLead>): Promise<Array<DishTVRechargeLead>> {
    return await Promise.all(value.map(async (x)=>await from_candid_DishTVRechargeLead_n11(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MobileRechargeLead>): Promise<Array<MobileRechargeLead>> {
    return await Promise.all(value.map(async (x)=>await from_candid_MobileRechargeLead_n16(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_WifiBookingLead>): Promise<Array<WifiBookingLead>> {
    return await Promise.all(value.map(async (x)=>await from_candid_WifiBookingLead_n19(_uploadFile, _downloadFile, x)));
}
